...
- 1770 — Witt — 1,\*2,3, \*\*en ut "Jena", \*\*en la « ça ira »
- 1770 — Beethoven — \*1,\*\*2,\*\*3,4,\*\*5,\*7,\*8,9
- 1771 — (Johann Joseph) Rösler — en ut
- 1772 — Cartellieri — \*\*1,3
- 1783 — (Antoine) Bohrer — Grande symphonie militaire
- 1784 — Spohr — 7
- 1784 — Onslow — 1,\*\*2,\*3,\*\*4
- 1784 — Ries — \*1,\*\*4,\*\*5,8
- 1785 — (Max) Bohrer — Grande symphonie militaire
- 1789 — Fesca (Friedrich Ernst) — 2,3
- 1791 — Czerny — \*\*1
- 1792 — (Cipriani) Potter — \*1, \*utm, \*utm, \*rém, solm, ré
- 1794 — Moscheles — en ut
- 1796 — Berwald — 2,3
- 1797 — Schubert — \*1,\*2,\*\*3,4,\*5,6,8,9
...
- 1810 — N. Burgmüller — \*1,\*2
- 1810 — Schumann — \*\*1,\*\*2,3,\*\*4
- 1810 — Nicolai — en ré / 2
- 1812 — (Emilie) Mayer — \*5
- 1813 — Macfarren — 4,7
- 1817 — Gade — 1,2,3,\*\*4,\*\*5,6,7,8
...
- 1834 — Ponchielli — 1,2
- 1835 — Draeseke — 1,4
- 1837 — Dubois — Symphonie française
- 1838 — Bizet — \*\*en ut, \*Roma
- 1838 — Bruch — \*\*1 (v.1868),2,3
- 1838 — Dente (Joseph) — \*en ré
- 1838 — Castillon – Esquisses symphoniques
- 1840 — Goetz — en fa, Op.9
- 1840 — Tchaïkovski — 1,\*\*2,\*\*3,4,\*\*5,\*6
- 1840 — Svendsen — 1,2
- 1841 — Dvořák — 7,8,9
- 1841 — (Elfrida) Andrée — 1
- 1843 — Grieg — \*en ut mineur
- 1843 — Hamerik — \*\*1,\*\*2,3,4,5,6
- 1846 — Noskowski — 1,2,\*\*3
- 1849 — Godard — 2
- 1850 — (Xaver) Scharwenka — en utm
- 1850 — Ole Olsen — 1
- 1851 — d'Indy — \*Italienne
- 1852 — Stanford — \*1,\*2,3,5,\*6
- 1852 — (Enrique) Oswald — \*\*Op.43, Sinfonietta
- 1853 — Messager — en la
- 1854 — Zweers — 2,3
- 1855 — (Arnold) Mendelssohn — 2
- 1855 — Chausson — \*en si bémol
- 1856 — Sinding — \*1,\*2,\*\*3,\*\*4
- 1856 — Martucci — 1,2
- 1856 — Taneyev — \*2,4
- 1857 — Kralik — \*Hymnische
- 1858 — Rott — \*\*en mi
- 1859 — Lyapunov — 1,2
- 1859 — Schjelderup — 2
- 1860 — (Felix) Woyrsch — 1
...
- 1865 — Dukas — en ut
- 1865 — Nielsen — \*\*1,\*\*2,3,\*\*4,6
- 1865 — Sibelius — 1,\*\*2,\*\*3,\*5a,\*\*5,\*6,\*\*7
- 1865 — Strohl — \*\*de la forêt
- 1866 — Kalinnikov — \*1,2
- 1866 — Georg Schumann — n°3 en fam
- 1867 — Beach – Symphonie gaélique
- 1868 — Bischoff — 1
- 1869 — Pfitzner — \*en ut
- 1869 — Roussel — 2,4
...
- 1872 — Alfvén — 1,\*2,\*\*3,\*\*4
- 1872 — Graener — \*Op.39
- 1872 — Vaughan Williams — \*1,\*3,\*5,8,9
- 1872 — H. Rosenberg — \*1,5
- 1872 — Kashperova — \*en sim
- 1872 — Scriabine — 2
- 1873 — Maliszewski — \*1,\*2,\*3,\*4
- 1874 — Stöhr — \*2, \*de chambre en fa
- 1874 — Schmidt — \*1,\*\*2,3,4
- 1874 — Holst — en fa « Cotswolds »
...
- 1895 — Rathaus — 2,3
- 1896 — Erdmann — 3,4
- 1896 — (Virgil) Thomson — \*2,3,On a Hymn Tune
- 1896 — (Roberto) Gerhard — 3
- 1897 — Fernström — 6,11
- 1897 — Korngold — Sinfonietta
- 1897 — (Paul) Ben-Haim — 1,\*\*2
- 1897 — Sæverud — 2
- 1898 — Harris — 2,\*3
...
- 1900 — Křenek — 2,\*3
- 1900 — Klami — 1,2
- 1901 — Rubbra — \*1,\*2,5,\*6,8
- 1901 — Groven — 2
- 1902 — Walton — \*\*1,2
- 1903 — Khatchaturian — 1
- 1904 — Kabalevski — \*1,2,3,\*4
- 1904 — Popov — \*\*1,2
- 1905 — Wirén — 3
- 1905 — Bacevičius — 3
- 1905 — K.-A. Hartmann — 1,2,3
- 1905 — Tubin — 1,3,11
- 1906 — Chostakovitch — 1,4,\*5,6,9,10,14
- 1906 — Doráti — 1,\*\*2,\*3
- 1906 — Papandopulo — 2
- 1906 — Creston – laquelle ?
- 1907 — (Walter) Kaufmann — 3
- 1908 — Carter — 1
- 1911 — Pettersson — 8
...
- 1932 — Lemeland — 6
- 1935 — Sallinen — 5,6
- 1936 — (Richard Rodney) Bennett — 1,\*2,3
- 1938 — Corigliano — 1,2
- 1939 — Tichtchenko — \*6
- 1944 — Nordgren — 4,\*7
- 1944 — Segerstam —
