...
categories: ["L'an 1899", "Les vidéos de Carnets sur sol", "Opéra-comique (et opérette)"]
vignette: "/medias/dame_blanche_crabe_tintin_55.png"
chapo: |
  Le palmarès des opéras les plus joués de la maison ! <br><br>
...
![Page 55 du Crabe d'or](/medias/dame_blanche_crabe_tintin_55.png "Page 55 du Crabe d'or") <br>
<small>(page tirée du <i>Crabe aux pinces d'or</i>)</small>
...
![la_dame_blanche_estampe_d_alfred_lemoine.jpg](/medias/la_dame_blanche_estampe_d_alfred_lemoine.jpg "la_dame_blanche_estampe_d_alfred_lemoine.jpg")
  
--

Dans cette vidéo, on parle des œuvres qui ont été le plus données à l’Opéra-Comique. Au sommet de ce palmarès, de très loin : *La Dame blanche* de Boïeldieu. 

--

## FORTUNE

Succès immédiat, modèle du genre. Boïeldieu immédiatement admiré de tous. Joué à la Cour dans la foulée des premières représentations. Les répliques sont même entrées dans la conversation courante comme Pelléas chez moi. 
Liszt résume assez bien l’avis général : « tout est enchaîné et ciselé avec grâce, les ornements sont utilisés dans une proportion raisonnable et la mélodie se distingue par une sorte de sentimentalité espiègle ». (Je n'ai pas mis à l'épreuve la véracité du texte.)
...
Projet de Scribe dès 1821 (*La Dame d’Avenel*), inspiré de Walter Scott : *Guy Mannering* (1815) et *Monastère* (1820). C’est aussi la mode aux ballades écossaises (en Allemagne puis en France) et aux histoires de lutins  (*Trilby* de Charles Nodier, en 1822, peut-être parmi les inspirations de Scribe). <br>
...
Pour finir cette notule, quelques extraits des dernières pages de *Rackham*.

![fin de Rackham le Rouge](/medias/rackham_01.png "fin de Rackham le Rouge")

![fin de Rackham le Rouge](/medias/rackham_02.png "fin de Rackham le Rouge")

![fin de Rackham le Rouge](/medias/rackham_03.png "fin de Rackham le Rouge")