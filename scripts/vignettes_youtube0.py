...
def main():
    ...
    print(f"\n{reussies} vignette(s) posée(s), {echouees} échec(s).")
    if echouees:
        print("Un échec laisse la notule intacte, sans image : elle "
              "retombera sur son chapô dans le fil.")
    print("\nRelancez « npm run build », puis vérifiez la page d'accueil.")
    print("Pensez à valider les images :  git add public/medias/youtube")
